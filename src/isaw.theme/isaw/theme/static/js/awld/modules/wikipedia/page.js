...
define(function() {
    return {
        ...
        toDataUri: function(uri) {
            ...
            return 'https://en.wikipedia.org/w/api.php?format=json&action=parse&page=' + pageId + '&callback=?';
        },
        parseData: function(data) {
            ...
            description = description.replace(/href="\//g,'href="https://en.wikipedia.org/')

            var imageURI = $('.image img',$content);
            imageURI = typeof imageURI.first()[0] === 'object' ? imageURI = 'https:'+imageURI.first()[0].getAttribute('src') : '';
