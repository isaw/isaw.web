...
def setup_product():
    ...
    import isaw.exhibitions
    zcml.load_config('configure.zcml', isaw.exhibitions)
    ...
    ztc.installPackage('isaw.exhibitions')
...
setup_product()
ptc.setupPloneSite(products=['isaw.exhibitions'])
